...
class Component:
    DESCRIPTION = "Close a HaloITSM ticket with optional resolution details"
...
class CloseTicketInput(insightconnect_plugin_runtime.Input):
  ...
  "properties": {
    ...
    "resolution": {
      "type": "string",
      "title": "Resolution",
      "description": "Resolution details for closing the ticket",
      "order": 2
    },
    "status_id": {
      "type": "integer", 
      "title": "Status ID",
      "description": "Status ID to set for the closed ticket (default: 4 for Resolved)",
      "default": 4,
      "order": 3
    }
  },
...
class CloseTicketOutput(insightconnect_plugin_runtime.Output):
  ...
  "properties": {
    "ticket": {
      ...
      "title": "Ticket",
      "description": "The closed ticket details",
      "order": 1
    },
    "success": {
      "type": "boolean",
      "title": "Success",
      "description": "Whether the ticket was successfully closed",
      "order": 2
    }
  },
  "required": [
